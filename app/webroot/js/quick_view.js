   ...
   var e = 0;
        $(".quickV").click(function(){
                ...
                success: function(data){
                    ...
                    {
                       $('#grdiv').append('<div id="img" class="img1 item-slick3" data-thumb="/wedding1/img/images/Uploaded_Photo/'+array.Image[i].name+'"><div id="imgsrc" class="wrap-pic-w pos-relative"><img src="/wedding1/img/images/Uploaded_Photo/'+array.Image[i].name+'" alt="IMG-PRODUCT"><a id="imghref" class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/wedding1/img/images/Uploaded_Photo/'+array.Image[i].name+'"><i class="fa fa-expand"></i></a></div></div>');
                    }
                   if(array.Categorie.name == 'Shoes')
                   {
					   $('.drop-down').empty().append('<option>Choose an option</option><option>38</option><option>39</option><option>40</option><option>41</option><option>42</option><option>43</option><option>44</option>');
				   }
                   else {
					   $('.drop-down').empty().append('<option>Choose an option</option><option>Size S</option><option>Size M</option><option>Size L</option><option>Size XL</option>');
				   }
                    setTimeout(function(){
