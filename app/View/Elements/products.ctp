...
<?php  foreach($produits as $produit){  ?>
	<div class="isotope-item <?php echo $produit['Categorie']['id']; ?> <?php echo $produit['Sex']['id']; ?>">
	<div style="margin-bottom: 120px; max-width: 345px; max-height:472px; padding:15px; " class="product    p-b-35   ">
		<!-- Block2 -->
		<div class="block2" >
