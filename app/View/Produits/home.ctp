...
<!--===============================================================================================-->
	<?php echo $this->Html->css('../fonts/iconic/css/material-design-iconic-font.min'); ?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../fonts/linearicons-v1.0.0/icon-font.min'); ?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../vendor/animate/animate'); ?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../vendor/css-hamburgers/hamburgers.min') ;?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../vendor/animsition/css/animsition.min'); ?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../vendor/select2/select2.min'); ?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../vendor/daterangepicker/daterangepicker'); ?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../vendor/slick/slick'); ?>
<!--===============================================================================================-->
	<?php echo $this->Html->css('../vendor/MagnificPopup/magnific-popup'); ?>
<!--===============================================================================================-->
...
<body class="animsition">
	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo">
						<?php echo $this->html->image('images/icons/log.png',array('alt'=>'IMG-LOGO','class'=>'log')); ?>
					</a>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 ">
							<a style="color:black;" href="<?php echo $this->Html->url(array('controller'=>'users','action'=>'add')); ?>"><span class="sspan">Signup</span></a>
						</div>

						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 ">
							<a  class="logbtn" href="<?php echo $this->Html->url(array('controller'=>'users','action'=>'login')); ?>"><span>Login</span></a>
						</div>
						<?php }else{ ?>
							<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 ">
							<a style="color:black;" href="<?php echo $this->Html->url(array('controller'=>'users','action'=>'logout')); ?>"><span class="sspan">Logout</span></a>
							</div>
						<?php } ?>
					</div>
				</nav>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><?php echo $this->html->image('images/icons/logo-01.png',array('alt'=>'IMG-LOGO')); ?></a>
			</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(<?php echo $this->Html->url('/img');?>/images/slide-01.jpg);">
				...
				<div class="item-slick1" style="background-image: url(<?php echo $this->Html->url('/img');?>/images/slide-02.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(<?php echo $this->Html->url('/img');?>/images/slide-03.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
	...
	<div class="sec-banner bg0 p-t-80 p-b-50">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<?php echo $this->Html->image('images/banner-01.jpg',array('alt'=>'IMG-BANNER'));?>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<?php echo $this->Html->image('images/banner-02.jpg',array('alt'=>'IMG-BANNER'));?>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<?php echo $this->Html->image('images/banner-03.jpg',array('alt'=>'IMG-BANNER'));?>
			...
			<!-- Load more -->
			<div class="flex-c-m flex-w w-full p-t-45" style="position: relative; bottom: 40px;">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<?php echo $this->Html->image('images/icons/icon-close.png',array('alt'=>'CLOSE')) ; ?>
				</button>
	...
	<?php echo $this->Html->script('myfile2'); ?>
